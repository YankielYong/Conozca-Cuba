...
public class Reporte8 extends JPanel{

	private static final long serialVersionUID = 1L;

	private Reporte8 este;
	public Reporte8(){
		este = this;
		...
		try {
			...
			JasperReport report = (JasperReport)JRLoader.loadObject(getClass().getResource("/reports/Reporte8.jasper"));
