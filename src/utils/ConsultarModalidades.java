...
public class ConsultarModalidades extends MiJPanel{
	...
	private TransportModalityTableModel tableModel;

	private Principal padre;
	private MiJPanel anterior;
	private ConsultarModalidades este;
	
	public ConsultarModalidades(Principal p, MiJPanel a){
		este = this;
		padre = p;
		anterior = a;
		setTipoPanel(Paneles.PANEL_CONSULTAR_MODALIDADES);
		padre.setPanelAbierto(getTipoPanel());
		padre.setPanelConsultarModalidades(este);
		...
		JLabel lblModal = new JLabel("Modalidades de Transporte");
		lblModal.setHorizontalAlignment(SwingConstants.CENTER);
		lblModal.setHorizontalTextPosition(SwingConstants.CENTER);
		lblModal.setForeground(Color.black);
		lblModal.setFont(new Font("Arial", Font.BOLD, 22));
		lblModal.setBounds(100, 0, 400, 50);
		panelInferior.add(lblModal);
		...
		tableModel = new TransportModalityTableModel(){
			private static final long serialVersionUID = 1L;
			@Override
